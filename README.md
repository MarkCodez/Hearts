...
6. The player who plays the highest value card that matches the leading suit that round takes all the cards and sums their points up. That player will also start the next round.
7. Game lasts 13 rounds with each player playing 1 card each every round.
